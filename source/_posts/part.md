...
- 任何一个类库实际上都是一个模块
- 任何语言都有模块化的思想，如Java 的 import、C++的include、Node 的 require
- js恰好经历了从无到有的过程
...
### tips
<font color="red">单⼀一职责组件要建⽴立在可复⽤用的基础上，对于不可复⽤用的单⼀一职责组件我们仅仅作为独⽴立组件的内部组件即可</font>
...
* libs 页面的各种配置
* purchase下存放各种路由文件，他们百分之99都承担页面容器职责
